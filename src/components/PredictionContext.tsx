...
export function PredictionProvider({
    ...
    React.useEffect(() => {
        if (!userId) {
            localStorage.setItem(GUEST_STORAGE_KEY, JSON.stringify({ groupScores, hasUnsavedChanges }))
        }
        ...
        try {
            ...
            const groupUpserts = Object.keys(currentGroupScores)
                .filter(matchId => {
                    ...
                    return (
                        s &&
                        s.home !== null && s.home !== undefined && (s.home as unknown) !== '' &&
                        s.away !== null && s.away !== undefined && (s.away as unknown) !== ''
                    )
                })
                .map(matchId => ({
                    user_id: userId,
    ...
    return (
        <PredictionContext.Provider value={{
            ...
            <div style={{
                ...
                border: '1px solid var(--border-gold)', borderRadius: 50,
                ...
                <button
                    ...
                    style={{
                        ...
                        cursor: 'pointer', boxShadow: '0 4px 15px rgba(212,168,67,0.4)',
                    }}
                >

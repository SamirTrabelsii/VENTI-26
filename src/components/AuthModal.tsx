...
export default function AuthModal({ isOpen, onClose, onSuccess, title, subtitle }: AuthModalProps) {
    ...
    const toEmail = (u: string) =>
        `${u.trim().toLowerCase().replace(/[^a-z0-9_-]/g, '')}@venti26.app`
            ...
            <div className="relative w-full max-w-[400px] bg-[var(--surface)] border border-[var(--border)] rounded-[20px] overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="pt-8 px-6 text-center">
                    ...
                    <p className="text-sm text-dim mb-6">
                        {subtitle || "Create a free account to save your picks and join the leaderboard."}
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ padding: '24px 24px 28px' }}>
                    <div style={{ marginBottom: 18 }}>
                        <label className="block text-[11px] font-semibold tracking-[1.5px] uppercase text-muted mb-1.5">Username</label>
                        <input
                            type="text"
                    ...
                    <div style={{ marginBottom: 24 }}>
                        <label className="block text-[11px] font-semibold tracking-[1.5px] uppercase text-muted mb-1.5">Password</label>
                        <input
                            type="password"
                    ...
                    >
                        {loading
                            ...
                            : mode === 'login' ? 'Sign In & Save →' : 'Create Account & Save →'
                        }
                    </button>
                </form>
            </div>

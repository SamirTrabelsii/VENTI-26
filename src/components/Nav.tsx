      ...
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 md:px-8 h-[72px] bg-[#050505]/95 backdrop-blur-md transition-all duration-300">
        ...
        >
          ...
          <span className="font-display text-[22px] tracking-[0.25em] text-white ml-3 hidden sm:block transition-all duration-500 group-hover:text-[var(--gold)] group-hover:drop-shadow-[0_0_8px_rgba(212,168,67,0.5)]">
            VENTI
            <span className="text-white/30 group-hover:text-[var(--gold)]/50">
              ·
            </span>
            26
          </span>
            ...
            return (
              ...
              >
                <tab.icon
                  ...
                  className={
                    active
                      ? "text-[var(--gold)] drop-shadow-[0_0_5px_rgba(212,168,67,0.5)]"
                      : "opacity-60"
                  }
              ...
              {menuOpen && (
                ...
                >
                  <div className="px-5 py-4 border-b border-[#222] bg-[#111]">
                    <p className="text-[10px] text-zinc-500 font-bold mb-1 uppercase tracking-[0.2em]">
                      Signed in as
                    </p>
                    <p className="text-sm text-white font-display tracking-wide truncate">
                      {displayName || "Player"}
                    </p>
                  </div>
                  <div className="p-2">
          ...
          {TABS.map((tab) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`flex flex-col items-center gap-1.5 transition-all duration-400 ${active ? "scale-100" : "scale-95 opacity-60 hover:opacity-80"}`}
                >
                  <Icon
                    size={20}
                  ...
                  />
                  <span
                    className={`text-[9px] uppercase tracking-[0.1em] transition-colors duration-400 ${active ? "font-bold text-[var(--gold)]" : "font-medium text-zinc-500"}`}
                  >
                    {tab.label}
                  </span>
                </div>

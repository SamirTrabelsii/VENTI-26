            ...
            <div style={{ width: '100%', maxWidth: 400, position: 'relative' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 36 }}>
                    <h1 style={{
                        ...
                        VENTI<span style={{ color: 'var(--cream)', opacity: 0.25 }}>·</span>26
                    </h1>
                    ...
                    <form onSubmit={handleSubmit} style={{ padding: '24px 24px 28px' }}>
                        ...
                        >
                            {loading
                                ...
                                : mode === 'login' ? 'Sign In →' : 'Create Account & Play →'
                            }
                        </button>
                ...
                <p style={{ textAlign: 'center', fontSize: 11, marginTop: 20, color: 'var(--muted)' }}>
